import { z } from 'zod';
export declare const StabilitySchema: z.ZodEnum<
...
export declare const ComponentMetadataSchema: z.ZodObject<
  {
    ...
    stability: z.ZodOptional<
      z.ZodEnum<['experimental', 'stable', 'deprecated']>
    >;
  },
  'strip',
  z.ZodTypeAny,
...
>;
export declare const AIExecutionModeSchema: z.ZodEnum<
  ['scaffold', 'customize', 'personalize']
>;
export declare const AIExecutionEnvironmentSchema: z.ZodEnum<
  ['build', 'ci', 'device']
>;
export declare const ComponentAISchema: z.ZodObject<
  {
    ...
    generationContract: z.ZodOptional<
      z.ZodObject<
        {
          output: z.ZodEnum<
            ['tsx', 'props-json', 'variant-selection', 'json-patch']
          >;
          ...
          z.ZodObject<
            {
              ...
              >;
              schemaRef: z.ZodOptional<z.ZodString>;
              styleSystem: z.ZodOptional<
                z.ZodEnum<['tailwind', 'css-modules']>
              >;
              constraints: z.ZodOptional<z.ZodArray<z.ZodString, 'many'>>;
            },
            'strip',
